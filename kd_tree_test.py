### Vendored from https://github.com/Vectorized/Python-KD-Tree
...
class KDTreeUnitTest(unittest.TestCase):
    ...
    def test_all(self):
        ...
        points = []
        additional_points = [rand_point(dim) for x in range(10000)]
        query_points = [rand_point(dim) for x in range(10000)]
